  ...
  var us = u((xt) => {
    ...
    function hs({
      ...
      let { ixData: d, ixSession: y } = e.getState(),
        ...
        R = (0, Nt.default)(d, `actionLists.${i}`, {}),
        { actionItemGroups: A, useFirstGroupAsInitialState: M } = R;
    ...
    function Es(e) {
      ...
      let { store: r, computedStyle: n } = e,
        ...
        m = !d,
        I = dW(),
        { ixElements: R, ixSession: A, ixData: M } = r.getState(),
        N = fW(R, o),
        { refState: x } = R[N] || {},
        S = Re.getRefType(o),
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "64650a972a647b5aaa370d3e|489cd709-f618-d71b-be3b-44730d322fea",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-3": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64650a972a647b5aaa370d3e|5fe9ab7d-fbbb-adde-a791-00eaea078156",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-7": {
      ...
      target: {
        selector: ".link-block",
        originalId:
          "64650a972a647b5aaa370d3e|3586b3fc-5839-05a2-8b8b-de2c80ba03e8",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-9": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64650a972a647b5aaa370d3e|7cdfac5d-3edc-4145-f915-59a0fb4111f5",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".image-2",
                  selectorGuids: ["d982550e-5b28-25fd-9c8f-3d3b4008baa7"],
                },
                xValue: 8,
                xUnit: "px",
                yUnit: "PX",
